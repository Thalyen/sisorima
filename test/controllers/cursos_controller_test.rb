...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { duracao: @curso.duracao, nome: @curso.nome, totalCredito: @curso.totalCredito }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { duracao: @curso.duracao, nome: @curso.nome, totalCredito: @curso.totalCredito }
    assert_redirected_to curso_path(assigns(:curso))
  end
